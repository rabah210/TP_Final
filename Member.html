...
<html lang="en">
  <head>
    ...
    <title>Member</title>
    <link rel="stylesheet" href="../TP_Final/Css/Member.css" />
  ...
  <body>
    <header>
      ...
      <ul class="Sign">
        <li id="Sign-in"><a href="../TP_Final/SignIn.php">Amir</a></li>
        <li id="Sign-up">
          <a href="../TP_Final/SignIn.php"
            ><img src="../TP_Final/Img/Aouameur.png" alt=""
          /></a>
        </li>
      </ul>
    </header>
    <div class="content">
      <aside class="side_bar">
        ...
        <ul class="Filters">
          ...
          <li style="display: flex; flex-direction: row; flex-wrap: nowrap">
            <i
              class="fa-regular fa-circle fa-2xs"
              ...
              <td style="display: flex; flex-direction: row; flex-wrap: nowrap">
                ...
                <h4 style="position: relative; top: -11px">
                  <p style="margin-bottom: 1px">
                    Programming at the highest level and Algerian youth
                  </p>
                  <div id="Name-Time">
